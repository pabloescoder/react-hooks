...
Elaborate on your learnings here in `src/exercise/05.md`<br><br> Learned how to
use useRef hook and the ref attribute to return DOM nodes from React which we
can manipulate manually, and how a cleanup function is required whenever we
explicitly attach event listeners to DOM nodes.
