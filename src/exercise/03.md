...
how to lift state up so that sibling components can use the same state and how
state can be "pushed down" or colocated, if there is only one component using
that state.
