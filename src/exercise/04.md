...
Elaborate on your learnings here in `src/exercise/04.md`<br /> <br /> Created
tic tac toe which saves the history of all the steps taken and saves the current
game in memory (localStorage)
